    ...
    return (
        <>
            ...
            <div className="container-fluid my-1">
                <button onClick={ShowOrHideCanvaHandler} style={{ display: button ? 'none' : 'block' }} className="navbar-toggler border border-2 p-1" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
