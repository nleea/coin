    ...
    return (
        <>
            ...
            <div className="container-fluid my-1 ">
                <button onClick={ShowOrHideCanvaHandler} style={{ visibility: button ? 'hidden' : 'visible' }} className="navbar-toggler my-2 p-1 float-start" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
